...
export async function getEvents(geoHash) {
  ...
  const dateString = `${tomorrow.getFullYear()}-${tomorrow.getMonth() + 1}-${tomorrow.getDate()}T${String(tomorrow.getTimezoneOffset() / 60).padStart(2, "0")}:${tomorrow.getMinutes()}:${tomorrow.getSeconds()}Z`;
